...
public class UserRepository : BaseRepository<AppUser>, IUserRepository
{
        ...
        string role, bool shouldConfirmImmediately)
    {
        ...
        {
            return new ServiceResult<(AppUser appUser, string token)>(ServiceResultType.InternalError,
        ...
        if (!string.IsNullOrWhiteSpace(role))
        {
            ...
            {
                return new ServiceResult<(AppUser appUser, string token)>(ServiceResultType.InternalError,
                    DatabaseUtilities.CreateErrorMessage(roleAssignmentResult.Errors));
            }
        }
    ...
    public async Task<ServiceResult<AppUser>> ConfirmUserEmailAsync(string email, string token)
    {
        ...
        {
            return new ServiceResult<AppUser>(ServiceResultType.InternalError,
                DatabaseUtilities.CreateErrorMessage(confirmationResult.Errors));
        }
