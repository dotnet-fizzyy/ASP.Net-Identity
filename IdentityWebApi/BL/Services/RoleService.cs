...
namespace IdentityWebApi.BL.Services
{
    public class RoleService : IRoleService
    {
        ...
        {
            var roleEntityResult = await _roleRepository.GetRoleByIdAsync(id);
        ...
        public async Task<ServiceResult<RoleDto>> CreateRoleAsync(RoleCreationActionModel roleDto)
        {
            ...
            return await HandleAppRoleEntity(_roleRepository.CreateRoleAsync, roleEntity);
        }
        ...
        public async Task<ServiceResult<RoleDto>> UpdateRoleAsync(RoleDto roleDto)
        {
            ...
            return await HandleAppRoleEntity(_roleRepository.UpdateRoleAsync, roleEntity);
        }
